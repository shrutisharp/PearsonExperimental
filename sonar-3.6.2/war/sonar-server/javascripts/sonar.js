...
D.html(E);
D.dialog({width:C,draggable:false,autoOpen:false,modal:true,minHeight:50,resizable:false,close:function(){$j("#modal").remove()
}});
D.dialog("open")
...
}function formDeleteIssueComment(D){var A=$j(D).closest("[data-comment-key]");
var C=A.attr("id");
var B=A.attr("data-comment-key");
return openModalWindow(baseUrl+"/issue/delete_comment_form/"+B+"?htmlId="+C,{})
